...
namespace sqlite::utility {
    ...
    inline void variant_select_null(Callback &&callback) {
        if
        constexpr(
                std::is_same_v<typename VariantFirstNullable<Options...>::type, void>) {
    ...
    inline auto variant_select_integer(Callback &&callback) {
        if
        constexpr(std::is_same_v<typename VariantFirstIntegerable<Options...>::type,
                void>) {
    ...
    inline auto variant_select_float(Callback &&callback) {
        if
        constexpr(std::is_same_v<typename VariantFirstFloatable<Options...>::type,
                void>) {
    ...
    inline void variant_select_text(Callback &&callback) {
        if
        constexpr(
                std::is_same_v<typename VariantFirstTextable<Options...>::type, void>) {
    ...
    inline auto variant_select_blob(Callback &&callback) {
        if
        constexpr(
                std::is_same_v<typename VariantFirstBlobable<Options...>::type, void>) {
